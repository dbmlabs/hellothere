...
<html>
<head>
<script src="http://neuralengr.com/asifr/journals/jquery.min.js"></script>
<script src="http://neuralengr.com/asifr/journals/scripts.js"></script>
<style type="text/css">
	  ...
	  <body>
	    ...
	    <div class="container">
	      <form class="form-signin" action="/login" method="POST">
	        <h2 class="form-signin-heading">Project Exosphere Sign In</h2>
	            ...
	            <label class="control-label" for="field1">Weekly Report</label>
	                ...
	                <div class="row">
	                  <div class="col-md-6">
	                    ...
	                    <div class="col-md-4">
	                      <form class="form-inline" action="/jcham" method="POST">
...
`
	...
	.glyphicon
	{
	    font-size: 20px;
			...
			<script>
			 ...
			 var str = $('.control-group').html(),
				 //regex = /(?:\s|^)(?:#(?!\d+(?:\s|$)))(\w+)(?=\s|$)/gi;
				 regex =/(#[a-z0-9][a-z0-9\-_]*)/ig
				 function replacer(hash){
					 var replacementString = $.trim(hash);
					 return ' <a href="https://vmware-com.socialcast.com/topics/'+ replacementString +'" target="_blank">' + replacementString + '</a>';
				 }
			 $('.control-group').html( str.replace( regex , replacer ) );
	...
	<body>
	  ...
	  <div class="row">
	        <div class="control-group" id="fields">
	            <label class="control-label" for="field1"><h3>Weekly Report - Manager Page</h3></label>
...
`
	form = `
	<div><!--start of loop--><br><div class="pull-right"><a href="#" class="remove_field"><button class="btn btn-danger btn-minus" type="button" align="right"><span class="glyphicon glyphicon-minus"></span></button></a></div><div class="entry input-group col-xs-10"><h3><div class="edit">{{.Title}}</div></h3></div><div class="entry input-group col-xs-12"><div class="edit">{{.Content}}</div></div><div class="entry input-group col-xs-12"><div class="edit">{{.Hash}}</div></div><div class="entry input-group col-xs-12"><button type="button" class="btn btn-info"><div class="edit">{{.Group}}</div></button></div></div>
    `
)
